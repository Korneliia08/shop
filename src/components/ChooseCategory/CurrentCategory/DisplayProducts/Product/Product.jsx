    ...
    return(
        <div className={styleProduct.block} onClick={setUrl}>
            <div className={styleProduct.blockForImage}>
                <img src={data.image} alt="image Clothes" className={styleProduct.img}/>
                <div className={styleProduct.blockForReadMore}><span className={styleProduct.spanReadMore}>Read more</span></div>
            </div>
